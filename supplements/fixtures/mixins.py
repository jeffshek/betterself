...
class SupplementModelsFixturesGenerator(object):
    ...
    def create_fixtures(cls):
        ...
        ingredient_1 = IngredientFactory(**DEFAULT_INGREDIENT_DETAILS_1)
        ingredient_2 = IngredientFactory(**DEFAULT_INGREDIENT_DETAILS_2)
        ingredient_3 = IngredientFactory(**DEFAULT_INGREDIENT_DETAILS_3)
        ...
        ingredient_composition_1 = IngredientCompositionFactory(
            ingredient=ingredient_1, measurement=measurement
        )
        ingredient_composition_2 = IngredientCompositionFactory(
            ingredient=ingredient_2, measurement=measurement
        )
        ingredient_composition_3 = IngredientCompositionFactory(
            ingredient=ingredient_3, measurement=measurement
        )

        # factory boy is a little bit special for many to many
        SupplementFactory.create(ingredient_composition=(
