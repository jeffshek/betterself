          ...
          <div className="col-md-6 col-md-offset-6 col-sm-8 col-sm-offset-4 content clearfix">
            ...
            <div className="row pad45">
              <div className="col-sm-6">
                ...
                <p>Small improvements move glaciers. Track what's working for you (and what's not). We can text or email reminders to keep your medications and supplements on track. Comes with beautiful personalized analytics from best-in-class algorithms.</p>
              </div>
              <div className="col-sm-6">
                <h5>Privacy First.</h5>
                <p>We're not here to sell your contact info to anyone else. We don't want your name or address. All we care about is improving health and productivity for our anonymous users. Open-sourced on GitHub.</p>
              </div>
            </div>
          </div>
        </div>
...
const OpenSourceAndApplicationSupport = () => {
  return (
    <section id="content-2-1" className="content-block content-2-1 bg-deepocean">
      <div className="container text-center">
        <a href="https://github.com/jeffshek/betterself" className="btn btn-outline btn-outline-xl outline-light">Made with <span className="fa fa-heart pomegranate" /> on GitHUb</a>
        <h2>Track your progress on <b>iOS</b> or <b>Android</b>&nbsp;devices.</h2>
      </div>
    </section>
  )
}
